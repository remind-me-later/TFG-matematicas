...
\begin{definition}[Type theoretic set]
  ...
  \[
  \texttt{Set} \ (\alpha : \texttt{Type}) \triangleq \alpha \to \texttt{Prop}
  \]
\end{definition}
...
\[
  \texttt{add}_n: \frac{
    \texttt{add}_n: \displaystyle{\frac{
      \texttt{var}_n: (x, s_0) \Longrightarrow_a 0
      \quad
      \texttt{val}_n: (5, s_0) \Longrightarrow_a 5
    }{(x + 5, s_0) \Longrightarrow_a 5}}
    \quad 
    \texttt{sub}_n: \displaystyle{\frac{
      \texttt{val}_n: (9, s_0) \Longrightarrow_a 9
      \quad
      \texttt{val}_n: (7, s_0) \Longrightarrow_a 7
    }{(9 - 7, s_0) \Longrightarrow_a 2}}
  }
  {((x + 5) + (9 - 7), s_0) \Longrightarrow_a 7}
\]
\end{example}
...
\begin{definition}[Behavioral equivalence]
  ...
  \[
  c_1 \sim c_2 \triangleq \forall s_1, \forall s_2, (c_1, s_1) \Longrightarrow_n s_2 \iff (c_2, s_1) \Longrightarrow_n s_2
  \]
\end{definition}
