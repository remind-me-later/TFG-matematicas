\documentclass[a4paper, 10pt, parskip=half, DIV=20]{scrartcl}
...
\[
  \texttt{add}_n: \frac{
    \texttt{add}_n: \displaystyle{\frac{
      \texttt{var}_n: \displaystyle{\frac{}{(x, s_0) \Longrightarrow_a 0}}
      \quad
      \texttt{val}_n: \displaystyle{\frac{}{(5, s_0) \Longrightarrow_a 5}}
    }{(x + 5, s_0) \Longrightarrow_a 5}}
    \quad 
    \texttt{sub}_n: \displaystyle{\frac{
      \texttt{val}_n: \displaystyle{\frac{}{(9, s_0) \Longrightarrow_a 9}}
      \quad
      \texttt{val}_n: \displaystyle{\frac{}{(7, s_0) \Longrightarrow_a 7}}
...
evaluation of the \texttt{while} construct.
