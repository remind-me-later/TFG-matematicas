...
En la demnostración empezamos aplicando la extensionalidad funcional para introducir
un argumento anónimo de la aplicación de la función, con esto obtenemos la
...
Ahora basta distinguir casos, cuando \texttt{k == k'} se cumple y cuando no.
...
Basta distinguir los casos \texttt{k₁ == k'} y \texttt{k₂ == k'}.
