...
\begin{definition}[Reflexive transitive closure]
  ...
  \(\tyfont{ReflTrans}: (\alpha \to \alpha \to \texttt{Prop}) \to
  (\alpha \to \alpha \to \texttt{Prop})\) and denote it as 
...
the big and small-step semantics.
...
\begin{proof}
  ...
  \[h: \prod_{(c, s), (d, t)} (c, s) \rightsquigarrow (d, t) \to (c; c', s) \rightsquigarrow (d; c', t)
