...
function as:
  \begin{align*}
    \funfont{denote} \ \texttt{skip} &\coloneqq \funfont{SRel.id} \\
  ...
  \[
    W \ b \ f = \lambda g \mapsto \funfont{Set.ite} \ \{(s, \square) \mid b \ s\} \ (f \circ g) \ \funfont{id}
  \]
\end{definition}
...
\(L \coloneqq \texttt{while true {skip}}\).
...
All the code can be found in GitHub at \url{
  https://github.com/remind-me-later/SemanticsLean}.
...
\subsection{Order and Knaster-Tarski}

\lstinputlisting{../SemanticsLean/Semantics/Lattice.lean}

\subsection{Chains and Kleene}

\lstinputlisting{../SemanticsLean/Semantics/Chain.lean}
