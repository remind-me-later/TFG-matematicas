...
introduce the concepts of the Calculus of Constructions. And in general of
modern type theory, we will follow the exposition in~\cite{hottbook}.
...
Another important axiom is \hl{\emph{propositional extensionality}}, which
...
a proposition is a type \(\tyfont{Prop}\), \enquote{proofs} are terms of that type,
...
\hl{Let's consider the example of implication} (\(\implies\)) in propositional
...
\begin{notation}[Set builder]
  ...
  \[
  \{x \mid P\} \coloneqq \lambda x \implies P
  \]
\end{notation}
...
\begin{definition}[Subset]
  ...
  \[
  A \subset B \coloneqq \forall x, x \in A \implies x \in B
  \]
\end{definition}
